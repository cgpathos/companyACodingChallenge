...
import today.pathos.companya.codingtest.databinding.FragmentFavoriteBinding
...
class FavoriteFragment : Fragment() {
    ...
    private lateinit var bnd: FragmentFavoriteBinding
    ...
    override fun onCreateView(
        ...
        bnd = DataBindingUtil.inflate(inflater, R.layout.fragment_favorite, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        bnd.listFavorite.adapter = listAdapter
